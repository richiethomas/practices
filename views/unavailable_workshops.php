...
foreach ($unavailable_workshops as $wk) {
	...
	echo "<li class='mb-2'>$wkdate: <a href='workshop.php?wid={$wk['id']}'>{$wk['title']}</a><br><small>$start {$wk['costdisplay']} (USD), Instructor: <a href='teachers.php?tid={$wk['teacher_id']}'>{$wk['teacher_info']['nice_name']}</a></small></li>\n";	
}	
