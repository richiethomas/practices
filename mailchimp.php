...
<form action="//willhines.us8.list-manage.com/subscribe/post?u=881f841fbb8bf66576e6e66cf&amp;id=a74fad76eb" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="form-inline" target="_blank" novalidate>
    ...
    <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="form-control btn btn-primary" style="width:150px">
<!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
    <div class="clear"><div style="position: absolute; left: -5000px;"><input type="text" name="b_881f841fbb8bf66576e6e66cf_a74fad76eb" tabindex="-1" value=""></div>
</div>
</form>
</div>
<!--End mc_embed_signup-->
